...
import styles from './EmpDocsGargiWebPart.module.scss';
import * as strings from 'EmpDocsGargiWebPartStrings';

export interface IEmpDocsGargiWebPartProps {
  description: string;
}
...
export default class EmpDocsGargiWebPart extends BaseClientSideWebPart <IEmpDocsGargiWebPartProps> {
